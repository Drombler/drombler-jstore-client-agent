...
public class JStoreClientServiceConfiguration extends DromblerClientConfiguration {

    public JStoreClientServiceConfiguration(CommandLineArgs commandLineArgs) throws URISyntaxException, IOException, MissingPropertyException {
